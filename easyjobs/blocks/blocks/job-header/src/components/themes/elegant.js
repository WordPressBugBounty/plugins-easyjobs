							...
							<div className="about__company">
								...
								<div className="ej-company-info">
									{/* <?php if ( ! get_theme_mod( 'easyjobs_landing_hide_company_logo', false ) ) : ?> */}
										<div className="logo">
											<img src={logoImgUrl ? logoImgUrl : companyDetails?.logo} alt="" />
										</div>
									{/* <?php endif; ?> */}
									<div className="info">
										<h4 className="name">
											<a href={companyDetails?.website ? companyDetails?.website : '#'} target="_blank">
											...
											{companyDetails?.badge && 
												<span className="tooltip">
													...
													<span className="tooltiptext">{companyDetails?.badge?.label}</span>
												</span>
										}
										</h4>
								...
								{!companyDetails?.remove_cover_photo && companyDetails?.cover_photo &&
									<div className="about__company__bottom">
										<div className="ej-job-cover">
											<img src={coverImgUrl ? coverImgUrl : companyDetails?.cover_photo[0]} alt="cover_photo" />
										</div>
									</div>
								}
							</div>
